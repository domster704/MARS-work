...
// */
//public class FormOrderFragmentOld extends Fragment implements View.OnClickListener, TBUpdate {
...
//                try {
//                    isSales = !isSales;
//                    glbVars.setIconColor(mainMenu, R.id.NomenSales, isSales);
...
//        downloadPhotoTread = new Thread(new PhotoDownloadingRunnable(fileNames, kod5, isForced, getActivity()));
//        downloadPhotoTread.start();
//    }
//}
